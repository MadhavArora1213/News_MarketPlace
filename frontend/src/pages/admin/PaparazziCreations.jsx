...
const PaparazziCreationsPage = () => {
  ...
  useEffect(() => {
    fetchRecords();
  }, [currentPage, pageSize, categoryFilter, regionalFilter, sortBy, sortOrder]);
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
                ...
                <div>
                  ...
                  <div style={{ position: 'relative' }}>
                    <input
                      type="text"
                      placeholder="Search page name, region..."
                      value={search}
                ...
                {/* Category Filter */}
                <div>
                  <label style={{ display: 'block', fontSize: '12px', fontWeight: '700', color: theme.textSecondary, marginBottom: '8px', textTransform: 'uppercase' }}>Category</label>
                  <select
                ...
                <div>
                  ...
                  >
                    ...
                    {[...new Set(records.map(r => r.region_focused).filter(Boolean))].map(reg => (
                  ...
                  <thead>
                    <tr style={{ backgroundColor: '#f8fafc', borderBottom: '2px solid #e2e8f0' }}>
                      ...
                      {[
                        ...
                        { key: 'region_focused', label: 'Region Focused' },
