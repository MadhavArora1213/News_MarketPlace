            ...
            <div className="max-w-4xl mx-auto mt-6 flex flex-col md:flex-row items-center gap-4">
              ...
              <div className="bg-white p-2 px-4 rounded-lg border border-[#E0E0E0] shadow-sm flex items-center gap-2">
                ...
                <ShareButtons
                  ...
                  title="Real Estate Professional Influencers"
                  description="Connect with a diverse network of real estate professional influencers."
                  showLabel={false}
                  variant="ghost"
                  size="sm"
                />
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex gap-2 items-center">
                          ...
                          <div onClick={(e) => e.stopPropagation()}>
                            <ShareButtons
                              url={`${window.location.origin}/real-estates/${realEstate.id}`}
                              title={realEstate.name}
                              description={realEstate.profession}
                              showLabel={false}
                              variant="ghost"
                              size="sm"
                            />
