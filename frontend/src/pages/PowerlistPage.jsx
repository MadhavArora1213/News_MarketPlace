    ...
    <div className="min-h-screen" style={{ backgroundColor: theme.backgroundAlt }}>
      ...
      <section className="relative py-8 md:py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#E3F2FD] to-white border-b border-[#E0E0E0]">
        <div className="max-w-7xl mx-auto">
          ...
          >
            {/* Disclaimer with right-to-left animation */}
            <motion.div
              ...
              className="mb-6"
            >
              <div className="max-w-2xl mx-auto p-4 rounded-lg" style={{ backgroundColor: '#FFEBEE', border: `1px solid ${theme.danger}` }}>
                <p className="text-sm font-medium text-center" style={{ color: theme.danger }}>
