    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-[#FAFAFA]">
        <div className="max-w-7xl mx-auto">
          {isTranslating ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
              {[1, 2, 3, 4, 5, 6, 7, 8].map(i => (
                <div key={i} className="bg-white rounded-lg border border-[#E0E0E0] p-4 animate-pulse">
                  ...
                  <div className="flex justify-between mb-4">
                    <div className="w-14 h-4 bg-slate-50 rounded" />
                    <div className="w-14 h-4 bg-slate-50 rounded" />
                  </div>
          ...
          {!isTranslating && filteredGuides.length === 0 && (
