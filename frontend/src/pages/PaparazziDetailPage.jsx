        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-center gap-4">
            ...
            <div className="relative">
              <button
                onClick={() => setActiveShareId(activeShareId === 'paparazzi' ? null : 'paparazzi')}
                className="flex items-center gap-2 px-6 py-3 bg-white border border-slate-200 text-slate-600 rounded-lg hover:bg-slate-50 transition-colors"
              >
              ...
              {renderShareMenu(
                ...
                paparazzi?.instagram_page_name || 'Paparazzi',
                'paparazzi'
              )}
            </div>
          </div>
