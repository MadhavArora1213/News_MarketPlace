...
const PowerListSimplified = () => {
  ...
  return (
    <section className="py-4 md:py-6 lg:py-8 bg-[#E3F2FD] relative overflow-hidden">
      ...
      <div className="absolute top-10 left-5 w-20 h-20 bg-[#1976D2]/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-10 right-5 w-16 h-16 bg-[#FFFFFF]/20 rounded-full blur-2xl"></div>
      <div className="absolute top-1/3 right-1/4 w-12 h-12 bg-[#1976D2]/5 rounded-full blur-xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-6">
          <div className="bg-gradient-to-br from-[#9C27B0] to-[#7B1FA2] rounded-3xl p-4 md:p-6 lg:p-8 shadow-2xl border border-white/30 relative overflow-hidden w-full">
...
export default PowerListSimplified;