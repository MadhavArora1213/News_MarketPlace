    ...
    <section className="py-8 bg-[#E3F2FD] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="bg-gradient-to-br from-[#7B1FA2] to-[#4A148C] rounded-3xl p-8 md:p-12 lg:p-16 shadow-2xl border border-white/30 relative overflow-hidden w-full">
