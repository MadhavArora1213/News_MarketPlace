      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {loading ? (
          <div className="text-center py-20">
            ...
            <p className="text-lg text-[#757575]">{loadingPowerList}</p>
          </div>
        ) : error ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            <div className="space-y-8">
              <div className="flex items-start space-x-6 group">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#212121] mb-3 group-hover:text-[#1976D2] transition-colors duration-300">{recognitionText}</h3>
                  <p className="text-[#757575] text-lg leading-relaxed">{recognitionDesc}</p>
                </div>
              </div>
              <div className="flex items-start space-x-6 group">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#212121] mb-3 group-hover:text-[#4CAF50] transition-colors duration-300">{networkingText}</h3>
                  <p className="text-[#757575] text-lg leading-relaxed">{networkingDesc}</p>
                </div>
              </div>
              <div className="flex items-start space-x-6 group">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#212121] mb-3 group-hover:text-[#9C27B0] transition-colors duration-300">{visibilityText}</h3>
                  <p className="text-[#757575] text-lg leading-relaxed">{visibilityDesc}</p>
                </div>
              </div>
            </div>
